# Path: usekit.tools.convert.data.data_convert.py
# -----------------------------------------------------------------------------------------------
...
def convert_format(src: str, old: str, new: str, dst: str = None):
    """
    Main convert engine:
        convert_format("dbi_simple_txt.py", "txt", "csv")
    """
    if dst is None:
    ...
    # ----------------------------------------
    # 7) import dbi_wrap_txt → dbi_wrap_csv
    # ----------------------------------------
...
def convert_by_name(name: str, old: str, new: str, loc="dir"):
    ...
    Example:
        convert_by_name("dbi_simple_txt", "txt", "csv")
    ...
    # Example: .../wrap/txt/dbi_simple_txt.py → .../wrap/csv/dbi_simple_csv.py
    src_str = str(src)
...
def convert_by_name_v2(name: str, old: str, new: str, loc="dir"):
    ...
    Example:
        convert_by_name_v2("dbi_simple_txt", "txt", "json")
